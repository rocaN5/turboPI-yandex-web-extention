...
`;
const tpi_sort_icon_order_number = `
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor">
...
`;
const tpi_sort_icon_copy_single = `
...
`;
const tpi_sort_icon_inner_sortables = `
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor">
...
(function () {
    ...
    function fetchSortableData() {
        ...
        .then(data => {
            if (data && data.type === "PLACE" || data && data.type === "ZASYL" ) {
